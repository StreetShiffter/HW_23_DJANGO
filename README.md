...
В моделях products добавлено правило публикации продукта can_unpublish_product:
- Публикация доступна всем, но отменить может модератор или админ
- Кнопки удалить и редактировать доступны автору, модератору и админу
- Продукт теперь закрепляется за авторизованым пользователем
- использованыф защитныее миксины авторизации проверки прав

![Cтраница_контактов](./image/12-No right.jpg)
![Cтраница_контактов](./image/11-right.jpg)
